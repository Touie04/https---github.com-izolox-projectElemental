...
function module:Skill()
	...
	self.SpawnedAssets[WindTornado] = WindTornado
...
--	self.SpawnedAssets[WindTornado] = WindTornado
--	WindTornado.Position = MouseInfo
--	WindTornado.CFrame = CFrame.lookAt(WindTornado.Position,Vector3.new(self.PlayerObject.HumanoidRootPart.Position.X,WindTornado.Position.Y,self.PlayerObject.HumanoidRootPart.Position.Z))
--	WindTornado.Orientation = WindTornado.Orientation + Vector3.new(0,180,0)
--	WindTornado.Parent = workspace.Projectiles
	
--	--local bp = Instance.new("BodyVelocity")
--	--bp.MaxForce = Vector3.new(1,1,1) * 10^2
--	--bp.Velocity = (self.PlayerObject.HumanoidRootPart.CFrame.LookVector * 30)
--	--bp.Parent = WindTornado
